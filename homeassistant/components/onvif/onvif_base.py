...
class OnvifEntityBase(Entity):
    """Base common to all Onvif entities."""

    def __init__(self, device):
        """Initialize the Onvif event."""
        self.device = device
    ...
    def device_info(self):
        ...
        return {"identifiers": {(ONVIF_DOMAIN, self.device.serial)}}
...
class OnvifEventBase(OnvifEntityBase):
    """Base common to all Onvif entities from event stream."""
