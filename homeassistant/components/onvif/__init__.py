...
from .device import OnvifNetworkDevice, get_device
...
async def async_setup_entry(hass, config_entry):
    ...
    device = OnvifNetworkDevice(hass, config_entry)
...
async def async_unload_entry(hass, config_entry):
    """Unload Onvif device config entry."""
